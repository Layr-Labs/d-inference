...
GOTOOLCHAIN=go1.25.0 go test -race ./coordinator/api -run 'Test(RequestOutcome|ProfilerKillSwitch|Streaming|StreamRelay|NonStream|NonStreamingCompleteObject|ConfigurePendingCopiesMetadataDetails)'
```
