...
func (s *Store) ReconcileAppAttestEvidence(ctx context.Context, before time.Time, limit int) (int64, error) {
...
func (s *Store) QueueAppAttestReceiptRecovery(ctx context.Context, limit int) (int64, error) {
