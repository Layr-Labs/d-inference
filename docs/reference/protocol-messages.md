...
| Go ↔ Swift key pinning | `coordinator/inference/dispatch/provider_wire_test.go`; `provider-swift/Tests/ProviderCoreTests/ProtocolTests.swift`, `CapacityQuoteProtocolTests.swift` |
