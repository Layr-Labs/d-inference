...
| MDA binding | `coordinator/mdm/device_attestation.go` (`RequestDeviceAttestation`); `coordinator/attestation/mda.go`; `coordinator/registry/provider_evidence.go` (`SetMDAProofIfHardwareBound`); `coordinator/providercontrol/verification/mda_reuse.go` (`Verifier.AttachCachedMDA`) |
