...
- [App Attest revocation-at-dispatch gap](2026-09-15-app-attest-revocation-at-dispatch.md) — why assertion-time readiness leaves a revocation window after cached enforcement, with dispatch-time closure criteria.
