...
| Record | Status | Date | One line |
|---|---|---|---|
| [qwen-first-paged-ssd-rollout.md](qwen-first-paged-ssd-rollout.md) | In progress | 2026-09-06 | Initial three-Qwen activation scope, retained evidence, remaining gates and independent rollback controls |
