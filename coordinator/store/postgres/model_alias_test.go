...
func TestMemoryModelAliasRoundTrip(t *testing.T) {
	...
	if !got.OpenRouterOnly || got.SourceModel != "gemma-4-26b-source" || got.SourceKind != contracts.ModelAliasSourceAlias || got.OpenRouterSlug != "google/gemma-4-26b-it" || got.HuggingFaceID != "google/gemma-4-26b-it" {
