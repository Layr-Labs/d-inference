...
sequenceDiagram
    ...
    Coord->>Coord: Verify binary hash against known release hashes
...
| Binary hash policy | Pins provider binary to a known release hash. | Provider is marked untrusted. |
