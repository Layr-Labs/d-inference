...
// isPowerOfTen reports whether n is 1, 10, 100, 1000, ... (drop-log throttle
// key for sinks that count one drop at a time, e.g. the profile sink).
