...
- [App Attest enforcement receipt-renewal capacity review](2026-09-15-app-attest-enforcement-receipt-renewal-capacity.md) — the serial per-replica renewal ceiling, fail-closed backlog consequence, and pre-enforcement capacity gates.
