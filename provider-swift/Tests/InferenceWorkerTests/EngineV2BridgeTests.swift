...
struct EngineV2ErrorMappingTests {
    ...
    func capacityExhaustedIsRetryable() async {
        ...
        #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(classified) == 503)
    }
    ...
    func queueFullSentinelMapsToQueueFull() async {
        ...
        #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(classified) == 429)
    }
...
struct EngineV2FailLoudFactoryTests {
    ...
    func concurrencyClamp() {
        #expect(WorkerInferenceSupport.clampEngineV2Concurrency(0) == 1)
        #expect(WorkerInferenceSupport.clampEngineV2Concurrency(1) == 1)
        #expect(WorkerInferenceSupport.clampEngineV2Concurrency(4) == 4)
        #expect(WorkerInferenceSupport.clampEngineV2Concurrency(8) == 8)
        #expect(WorkerInferenceSupport.clampEngineV2Concurrency(24) == 8)
        #expect(WorkerInferenceSupport.clampEngineV2Concurrency(UInt64.max) == 8)
    }
}
