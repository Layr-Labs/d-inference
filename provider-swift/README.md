...
```text
Sources/
├── FanControlCore/            private AppleSMC policy + crash-safe leases
├── FanControlIPC/             narrow code-signature-gated XPC contract
...
├── darkbloom-fan-helper/       minimal root launchd/XPC helper
└── darkbloom-enclave-cli/      ArgumentParser SE helper
Tests/
├── FanControlCoreTests/       fan policy, codecs, IPC, and lease recovery
└── ProviderCoreTests/         protocol, inference, security, and lifecycle tests
```
...
darkbloom fan                       optional inference-aware cooling boost
