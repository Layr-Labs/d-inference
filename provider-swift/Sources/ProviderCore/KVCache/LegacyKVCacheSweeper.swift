...
// at startup. v0.7.5 deleted that tier wholesale (the v2 prefix cache is
// RAM-only — T-041; the encrypted SSD-offload successor is a future
// design that will reuse `KVCacheKEK`). This sweeper preserves the two
