...
func (d *execution) writeTimingHeaderWithProfile(w http.ResponseWriter, pr *registry.PendingRequest) {
...
func (d *execution) applyProfileTiming(tj *types.RequestTimingDetails, pr *registry.PendingRequest) {
...
func (d *execution) stampFirstContent(pr *registry.PendingRequest) {
	ap := pr.Profile
	if ap == nil {
		return
	}
...
func (d *execution) stampCommitted(pr *registry.PendingRequest) {
...
func (d *execution) finalizeProfile() {
	rp := d.profile
	if rp == nil {
		return
	}
...
func (d *execution) stampClientGone(phase string) {
	rp := d.profile
	if rp == nil {
		return
	}
