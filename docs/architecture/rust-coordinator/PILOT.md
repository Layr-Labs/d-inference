...
- `/v1/admin/quiescence`, `/v1/admin/deposits`, `/v1/admin/terminal-ingest`,
  ...
  `/v1/admin/adopt-job`, `/v1/admin/adopt-jobs`, `/v1/admin/clear-orphans`, `/v1/admin/outbox-drain`, `/v1/admin/cutover-drain`, `/v1/admin/cutover-drain-all`, `/v1/admin/cancel-attempt`
