...
- [App Attest enforcement coordinator-backpressure review](2026-09-15-app-attest-enforcement-coordinator-backpressure.md) — how four-slot verifier/storage admission and coordinator failures can still stale healthy macOS 27 providers after enforcement.
