...
├── api/              HTTP + WebSocket handlers (consumer.go, provider.go, authentication.go, requestauth/, billing_handlers.go, device_auth.go, invite_handlers.go, release_handlers.go, enroll.go, stats.go, server.go, chunk_key_cache.go, types/)
