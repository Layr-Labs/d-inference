...
Tests/
├── ProviderCoreTests/         default tests plus explicit Live/Hardware/Probes/ReleaseGates
├── ProviderCoreFoundationTests/ default tests plus opt-in Resource tests
└── DarkbloomCLITests/         pure CLI tests plus opt-in real-binary Integration tests
```

See [`docs/developer/test.md`](../docs/developer/test.md) for the exact default
lane, cross-language shared fixtures, opt-in gates, and prerequisites.
