...
func TestWarmTargetDedicatedWholePool(t *testing.T) {
	...
	if got := c.targetWarm(dedicated, underDemand, c.targetInputs(dedicated, underDemand, warmPoolQueuePressure{}, 0), params, svc, now); got != 5 {
	...
	if got := c.targetWarm(dedicated, warmPoolPressureBucket{}, c.targetInputs(dedicated, warmPoolPressureBucket{}, warmPoolQueuePressure{}, 0), params, svc, now); got == 5 {
	...
	if got := c.targetWarm(nonDedicated, warmPoolPressureBucket{}, c.targetInputs(nonDedicated, warmPoolPressureBucket{}, warmPoolQueuePressure{}, 0), params, svc2, now); got != 2 {
