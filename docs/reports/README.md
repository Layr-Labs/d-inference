...
- [App Attest enforcement retry-freshness review](2026-09-15-app-attest-enforcement-retry-freshness.md) — why the 1m/5m/1h recovery ladder still exceeds the 15-minute assertion lifetime after macOS 27 enforcement.
