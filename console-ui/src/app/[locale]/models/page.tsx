                      ...
                      <div className="mb-3">
                        <div className="flex items-center gap-2 text-xs">
                          ...
                          <span className="text-text-tertiary opacity-50">
                            {eigenPricing[model.id].unit ?? t("perMillionTokens")}
                          </span>
                        </div>
                        {competitorPricing[model.id] && (
                          <div className="flex items-center gap-1.5 mt-1">
                            ...
                            <span className="text-xs font-medium text-accent-green">
                              {t("cheaper", {
                                percent: savingsPercent(eigenPricing[model.id].output, competitorPricing[model.id].output),
                              })}
                            </span>
                            <span className="text-xs text-text-tertiary opacity-50">
                              {t("vs", { competitor: competitorPricing[model.id].competitor })}
                            </span>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-border-dim">
                      <div className="flex items-center gap-1 text-text-tertiary">
                        ...
                        <span className="text-xs font-mono">
                          {t("providers", { count: model.provider_count ?? 0 })}
                        </span>
                      </div>
                      {model.attested && (
