...
- Preserve whole seconds in standard `darkbloom benchmark` first-token and total timings so derived decode throughput no longer reports inflated or zero values for generations longer than one second.
