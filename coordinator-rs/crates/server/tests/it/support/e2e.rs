//! Shared harness for the full-stack `e2e` suite: an ephemeral PostgreSQL
//! cluster (`crate::support::pg`) + the REAL bootstrap application on an
//! ephemeral port, plus the seed data, HTTP/provider drivers
//! (`crate::support::session::FakeProvider`), and DB money assertions
