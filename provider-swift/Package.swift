...
let package = Package(
    ...
    targets: [
        ...
        // ----------------------------------------------------------------
        // ProviderCoreTests — default hermetic coverage plus explicit
        // Live, Hardware, Probes, and ReleaseGates directories. Cross-language
        // protocol, security, and prompt contracts consume shared fixtures.
        // See docs/developer/test.md for every opt-in gate.
        // ----------------------------------------------------------------
        .testTarget(
        ...
        // ----------------------------------------------------------------
        // DarkbloomCLITests — pure command/config/diagnostic helpers plus the
        // opt-in Integration/ real-binary dispatch suite. The executable target
        // uses `@main` and remains importable via `@testable import darkbloom`.
        // ----------------------------------------------------------------
        .testTarget(
