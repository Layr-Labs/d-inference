...
type Release struct {
	...
	HasApp         *bool     `json:"has_app,omitempty"`          // derived from the verified release archive; nil for legacy rows
	HasFanHelper   *bool     `json:"has_fan_helper,omitempty"`   // derived from helper + signed marker presence
	HasPagedKernel *bool     `json:"has_paged_kernel,omitempty"` // derived from paged resource + signed marker presence
