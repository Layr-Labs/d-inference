...
const reveal = (step: number) => `stats-reveal stats-reveal-${step}`;

export const statsReveal = "stats-reveal";
export const statsReveal2 = reveal(2);
export const statsReveal3 = reveal(3);
export const statsReveal4 = reveal(4);
export const statsReveal5 = reveal(5);
export const statsReveal6 = reveal(6);
...
/** Grouped tokens used by the stats page to reduce import surface. */
export const statsPageStyles = {
  ...
  tokenBar: "rounded-[0.35rem] border border-border-dim bg-bg-primary px-5 py-5 shadow-sm",
} as const;
