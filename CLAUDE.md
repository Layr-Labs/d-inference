...
├── api/              HTTP + WebSocket handlers (consumer.go, provider.go, billing_handlers.go, device_auth.go, invite_handlers.go, releases/, statearchive/, admin_auth.go, enroll.go, stats.go, server.go, chunk_key_cache.go, types/)
