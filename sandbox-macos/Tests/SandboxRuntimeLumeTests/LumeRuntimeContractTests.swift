    ...
    func testRuntimePinMatchesAuditedLockFile() throws {
        ...
        XCTAssertEqual(
            ...
            [
                ...
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedRunLockIdentityPatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedRunLockIdentityPatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedBrokerLifecyclePatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedBrokerLifecyclePatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedIsolationPatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedIsolationPatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedRuntimeOwnershipPatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedRuntimeOwnershipPatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedFailureDiagnosticPatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedFailureDiagnosticPatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedStopCoalescingPatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedStopCoalescingPatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedManagedRestorePatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedManagedRestorePatchSHA256
                ),
                LumePatch(
                ...
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedOfflineFencePatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedOfflineFencePatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedInstallerProfilePatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedInstallerProfilePatchSHA256
                ),
            ]
        )
