...
| Capacity accept off the first-byte path | `coordinator/inference/dispatch/commit.go` (`commitFirstContent`); `coordinator/registry/capacity_cooldown.go` (`RecordCapacityAcceptObserved`) |
...
| Scan counter | `coordinator/registry/scheduler.go` (`RoutingDecision.ScanCount`); `coordinator/inference/dispatch/route_observation.go` (`recordRoutingDecisionFor`) |
