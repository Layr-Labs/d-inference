...
| [app-attest-retirement.md](app-attest-retirement.md) | Proposed | 2026-09-14 | Complete shadow policy, receipt and key lifecycle, live connection authorization, accounting continuity, and gates for removing APNs/MDM |
