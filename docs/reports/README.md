...
- [App Attest live-dispatch authorization gap](2026-09-15-app-attest-live-dispatch-authorization.md) — why archived prospective verdicts cannot authorize a live provider after enforcement, with the required dispatch boundary.
