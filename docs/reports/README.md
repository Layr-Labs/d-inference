...
- [App Attest machine-alias freshness review](2026-09-15-app-attest-machine-alias-freshness.md) — how periodic inventory refreshes a latched proof alias, its reporting-only impact, and pre-enforcement freshness gates.
