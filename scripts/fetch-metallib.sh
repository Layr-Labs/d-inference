...
R1_KERNEL_BK32_SYMBOL="affine_gather_qmm_gemma4_expert_tiles_bfloat16_t_gs_64_b_4_alN_true_bm_32_bn_32_bk_32"
R1_KERNEL_BK64_SYMBOL="affine_gather_qmm_gemma4_expert_tiles_bfloat16_t_gs_64_b_4_alN_true_bm_32_bn_32_bk_64"
...
COMPLETENESS_CONTRACT="$(
    printf '%s\n' "$NAX_SYMBOL" "$GEMV_SYMBOL" "$R1_BUILDER_SYMBOL" \
        "$R1_BUILDER_E256_SYMBOL" "$R1_KERNEL_BK32_SYMBOL" \
        "$R1_KERNEL_BK64_SYMBOL" \
