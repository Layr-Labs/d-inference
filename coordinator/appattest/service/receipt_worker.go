...
func (s *Service) newAppAttestReceiptWorker() *appAttestReceiptWorker {
...
func renewAppAttestReceipt(ctx context.Context, old store.AppAttestReceipt, cfg Config, client *http.Client) store.AppAttestReceipt {
