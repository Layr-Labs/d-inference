                ...
                if request.action == "attest" {
                    ...
                    for attempt in 0..<3 {
                        do {
                            ...
                            proof = try await service.attestKey(key.keyID, hash: hash)
                            break
                    ...
                    key.attested=true; key.pendingProof=nil; key.pendingEnrollment=nil; key.pendingStatus=nil; key.pendingCreatedAt=nil; key.attestationStartedAt=nil
