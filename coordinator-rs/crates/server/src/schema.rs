...
pub const MINIMUM_PUBLIC_SCHEMA_VERSION: i64 = 3;
pub const MAXIMUM_PUBLIC_SCHEMA_VERSION: i64 = 3;
pub const MINIMUM_RUST_SCHEMA_VERSION: i64 = 1;
pub const MAXIMUM_RUST_SCHEMA_VERSION: i64 = 1;
