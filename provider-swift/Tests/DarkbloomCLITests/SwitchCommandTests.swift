...
struct SwitchCommandTests {
    ...
    @Test func mailboxSeparatesSwitchFromStopAndBindsIdentity() throws {
        ...
        #expect(mailbox.readRequest() == drain && mailbox.claimSwitchRequest() == request)
        ...
        #expect(LifecycleMailbox(identity: reusedPID, directory: directory).claimSwitchRequest() == nil)
