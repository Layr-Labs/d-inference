...
- `/v1/admin/quiescence`, `/v1/admin/deposits`, `/v1/admin/terminal-ingest`,
  `/v1/admin/force-settle`, `/v1/admin/force-settle-batch`, `/v1/admin/recover-undispatched`, `/v1/admin/recover-undispatched-batch`, `/v1/admin/held-review`,
  `/v1/admin/adopt-job`, `/v1/admin/adopt-jobs`, `/v1/admin/clear-orphans`, `/v1/admin/outbox-drain`, `/v1/admin/cancel-attempt`
