...
// A THIRD regime exists since v0.8.16 — (version, model)-gated measured
// floors and weights (TestServabilityActivationFloorPerModel,
// TestServabilityColdWeightsPerModel) — but every call below passes
// modelID="", which always selects the flat floor, so the two-regime
// arithmetic in this test stays exact.
//
