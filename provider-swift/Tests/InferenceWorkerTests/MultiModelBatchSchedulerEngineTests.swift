...
func fromSchedulerMessageMapsQueueFull() {
    ...
    #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(err) == 429)
}
...
func fromSchedulerMessageMapsActiveTokenBudget() {
    ...
    #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(err) == 503)
}
...
func fromSchedulerMessageFallsThroughToGenerationFailed() {
    ...
    #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(err) == 500)
}
...
func platformTerminalStatusMapping() {
    ...
    for (cause, expected) in cases {
        ...
        let status = WorkerInferenceSupport.mapInferenceErrorToStatus(err)
...
func platformTerminalMetadataExtraction() {
    ...
    let meta = WorkerInferenceSupport.inferenceTerminalMetadata(from: terminal)
    ...
    let legacyMeta = WorkerInferenceSupport.inferenceTerminalMetadata(from: legacy)
    #expect(legacyMeta.cause == nil)
    #expect(legacyMeta.usage == nil)
    #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(legacy) == 500)
}
...
func invalidRoleMapsToBadRequest() {
    ...
    #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(err) == 400)
}
