//! Streaming live settle after ownership steal holds the reservation
//! (DECISIONS #49/#54) — checkpoint may advance in-process, money must not.
...
#[tokio::test]
async fn live_stream_settle_after_ownership_steal_holds() {
    ...
    state
        ...
        .upsert_lifecycle(ProviderSnapshot {
            provider_id: "p-stream-steal".into(),
            session_epoch: 1,
            trusted: true,
    ...
    hub.attach("p-stream-steal".into(), 1, tx).await;
    let hub2 = hub.clone();
                ...
                Some("start") => {
                    ...
                    hub2.deliver_reply(
                        ...
                        InboundReply::Terminal(json!({
                            ...
                            "terminal_digest": "sha256:stream-steal",
                            "prompt_tokens": 2,
                            "completion_tokens": 8,
                            "outcome": "completed"
                        })),
            ...
            Request::builder()
                ...
                .body(Body::from(
                    json!({
                        ...
                        "messages": [{"role":"user","content":"stream steal"}],
                        "stream": true
                    })
                    .to_string(),
                ))
