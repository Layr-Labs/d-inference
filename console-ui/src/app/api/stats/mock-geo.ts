// Mock geography fixtures for the stats route's `?mock=geo` dev mode.
// Plain data module — no runtime dependencies.
...
export type RequestLocationBucket = {
  key: string;
  scope: string;
  city?: string;
  region?: string;
...
export const MOCK_CITY_BUCKETS: LocationBucket[] = [
  {
...
export const MOCK_REGION_BUCKETS: LocationBucket[] = [
  {
    key: "us|ca",
    scope: "region",
    region: "California",
...
export const MOCK_REQUEST_CITY_BUCKETS: RequestLocationBucket[] = [
  {
    key: "us|ca|san francisco",
    scope: "city",
    city: "San Francisco",
...
export const MOCK_REQUEST_REGION_BUCKETS: RequestLocationBucket[] = [
  {
    key: "us|ca",
    scope: "region",
    region: "California",
...
export const MOCK_REQUEST_FLOWS: RequestFlowBucket[] = [
