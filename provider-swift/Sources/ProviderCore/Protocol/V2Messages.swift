...
/// Coordinator → Provider abort (pre-start, idempotent tombstone).
public struct AbortCommand: Codable, Sendable, Equatable {
    public var type: String = "abort"
    public var identity: AttemptIdentity
...
public struct AbortedReply: Codable, Sendable, Equatable {
    public var type: String = "aborted"
    public var identity: AttemptIdentity
...
public struct CancelledReply: Codable, Sendable, Equatable {
    public var type: String = "cancelled"
    public var identity: AttemptIdentity
