      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-3 sm:px-6 py-6 sm:py-8">
          ...
          <div className="rounded-xl bg-bg-secondary p-5 mb-8">
            ...
            <p className="text-xs text-text-tertiary mb-2">
              <span className="font-medium text-text-secondary">Base rewards</span> are paid on top of usage to attested machines that stay online ≥90% of the month, up to a fixed monthly budget — they are not a guarantee.
            </p>
            <p className="text-xs text-text-tertiary">
