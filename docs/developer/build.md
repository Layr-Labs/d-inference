...
The speculative terminal-order regressions also use only the Go coordinator
and isolated in-memory providers; see [coordinator checks](test.md#2-coordinator-go).
