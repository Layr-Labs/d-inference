...
// Store is a PostgreSQL-backed implementation of Store.
type Store struct {
	pool *pgxpool.Pool
...
func New(ctx context.Context, scfg contracts.Config) (*Store, error) {
...
func newPostgresWithPoolConfig(ctx context.Context, scfg contracts.Config, tune func(*pgxpool.Config)) (*Store, error) {
