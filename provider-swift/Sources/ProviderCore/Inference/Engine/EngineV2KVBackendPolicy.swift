...
// for exact policy-listed artifact IDs; runtime qualification remains separate.
// Explicit paged failures refuse the load; automatic
...
public enum EngineV2KVBackendPolicy {
    public static func preferredBackend(
        ...
        case .auto:
            if EngineV2SupportedModels.isBonsai2ListingModelID(modelID) { return .paged }
