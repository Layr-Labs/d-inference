...
func TestProviderLogReportSerialPrivacyMigration(t *testing.T) {
	combined := strings.Join([]string{
		startupschema.ProviderLogReportSerialGuardFunction,
		startupschema.ProviderLogReportSerialGuardTrigger,
		startupschema.ProviderLogReportSerialScrubMigration,
	}, "\n")
