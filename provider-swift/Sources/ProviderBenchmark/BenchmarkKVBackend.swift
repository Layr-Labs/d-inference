...
/// `--kv-backend auto` follows model eligibility and can fall back to
/// contiguous, while explicit `paged` can still be vetoed by policy or
/// the fleet kill switch. A phase that cannot name its
