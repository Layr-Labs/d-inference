...
| `EIGENINFERENCE_TTFT_OCCUPANCY_ALPHA` | float 0–1e6 | `0` (term off) | `coordinator/cmd/coordinator/routing_deadlines.go` (`validateTTFTOccupancyAlpha`) | Weight of the occupancy term in the diagnostic shadow TTFT estimate. |
