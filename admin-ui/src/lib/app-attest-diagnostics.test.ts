...
describe("pivotDeaths", () => {
  it("pivots per-day classifications newest first and folds unknown classes", () => {
    const days = pivotDeaths([
      { day: "2026-09-24", classification: "reboot", keys: "2", machines: "2", clean_exit: "1", unclean_exit: "0" },
      { day: "2026-09-25", classification: "process_restart", keys: "5", machines: "4", clean_exit: "0", unclean_exit: "5" },
      { day: "2026-09-25", classification: "something_new", keys: "1", machines: "1", clean_exit: "0", unclean_exit: "0" },
    ]);
