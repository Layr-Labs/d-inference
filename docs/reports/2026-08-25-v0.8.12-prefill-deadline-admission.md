...
- **Typed policy and precedence.**
  ...
  [`PrefillDeadlineMode.resolve(configured:environment:)`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/PrefillDeadlineMode.swift#L3-L23)
  ...
  [`ConfigTests`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/ConfigTests.swift#L43-L87),
  [`ConfigValidationTests`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/ConfigValidationTests.swift#L97-L108),
  and
  [`deadlineModeUsesSourceAwarePrecedence`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/EngineV2ProductionWiringTests.swift#L2192-L2221).
- **Production cap and mode wiring.**
  ...
  [`EngineV2Factory.maxConcurrentPartialPrefills` and `prefillDeadlineProjectionSupported`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Factory+Production.swift#L120-L154)
  resolve cap `1` versus unlimited/unsupported postures, while
  [`productionSchedulerConfig`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Factory+Production.swift#L172-L186)
  installs that cap in the scheduler.
  [`EngineV2Factory.makeBridge`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Config.swift#L150-L190)
  resolves the typed mode and supplies the projection-capability guard;
  [`EngineV2SlotFactory.makeProductionBundle`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2SlotFactory.swift#L262-L288)
  accepts the optional mode and runtime environment, then
  [reports unsupported postures and constructs the bridge](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2SlotFactory.swift#L616-L654)
  from those same inputs. The focused suite separately executes
  [resolver precedence](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/EngineV2ProductionWiringTests.swift#L2192-L2221),
  [direct `makeBridge` mode/cap wiring](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/EngineV2ProductionWiringTests.swift#L2223-L2280),
  [cap parsing and scheduler configuration](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/EngineV2ProductionWiringTests.swift#L2282-L2333),
  and the
  [slot-factory bypass diagnostic](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/EngineV2ProductionWiringTests.swift#L2335-L2365);
  those tests do not substitute for the wrapper handoffs cited above.
- **Bridge eligibility and calibration.**
  [`EngineV2Bridge.firstTokenDeadlineAdmission`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Bridge.swift#L1037-L1070)
  ...
  [`engine-submit boundary`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Bridge.swift#L819-L824)
  and revoked on overlap by
  [`isIsolatedPrefillSubmitBoundary` / `disqualifyOverlappedPrefillSamples`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Bridge.swift#L1072-L1093);
  [`finishAndEmit`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Bridge.swift#L1666-L1722)
  marks only natural `.stop` / `.length` terminals successful, and
  [`recordFinish`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Bridge.swift#L1785-L1829)
  invokes
  [`recordPrefillSample`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Bridge.swift#L1848-L1905)
  ...
  [`failOpenCasesUseOrdinarySubmit`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/EngineV2PrefillSamplingTests.swift#L768-L838).
...
- **Hard expiry and cap-zero rollback.**
  ...
  [`EngineV2Bridge.checkFirstContentDeadline`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Bridge.swift#L1157-L1191)
  remains independent of forecast mode and is called at the final
  [post-suspension pre-submit boundary](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Sources/ProviderCore/Inference/EngineV2Bridge.swift#L808-L817).
  Tests prove cap `0` uses ordinary submission while preserving expiry
  ([`capZeroUsesOrdinarySubmission`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/EngineV2PrefillSamplingTests.swift#L663-L697))
  and that every forecast fail-open branch still rejects expired work
  ([`expiredRequestsNeverFailOpen`](https://github.com/Layr-Labs/d-inference/blob/e0a0d16d9cedaa01d836ae88d021fcb9718c6556/provider-swift/Tests/ProviderCoreTests/EngineV2PrefillSamplingTests.swift#L840-L885)).
