...
struct EngineV2VisionRoutingTests {
    ...
    func constructionFailureRefusesLoudly() async throws {
        ...
        do {
            ...
            #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(error) == 503)
        } catch {
    ...
    func mediaErrorFromConstructionKeeps4xx() async throws {
        ...
        do {
            ...
            #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(error) == 400)
        } catch {
    ...
    func cancelDuringVisionConstructionPropagatesCancellation() async throws {
        ...
        do {
            ...
            #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(CancellationError()) == 499)
        } catch {
...
struct MultimodalErrorMappingTests {
    ...
    func admissionMessages() {
        ...
        for error in cases {
            ...
            #expect(WorkerInferenceSupport.mapInferenceErrorToStatus(typed) == 400)
        }
    }
