...
///     `Unmanaged.passRetained` — caller must eventually call `darkbloom_enclave_free()`
///   - Functions returning `UnsafeMutablePointer<CChar>?` (strings) use `strdup`
///     — caller must eventually call `darkbloom_enclave_free_string()`
...
/// freed with `darkbloom_enclave_free()` when no longer needed.
/// Returns NULL if the Secure Enclave is unavailable or key creation fails.
@_cdecl("darkbloom_enclave_create")
public func darkbloom_enclave_create() -> UnsafeMutableRawPointer? {
...
@_cdecl("darkbloom_enclave_free")
public func darkbloom_enclave_free(_ ptr: UnsafeMutableRawPointer) {
    Unmanaged<AnyObject>.fromOpaque(ptr).release()
}

/// Check if the Secure Enclave is available on this device.
/// Returns 1 if available, 0 if not.
@_cdecl("darkbloom_enclave_is_available")
public func darkbloom_enclave_is_available() -> Int32 {
...
@_cdecl("darkbloom_enclave_public_key_base64")
public func darkbloom_enclave_public_key_base64(
...
@_cdecl("darkbloom_enclave_verify")
public func darkbloom_enclave_verify(
...
/// `darkbloom_enclave_create_attestation_with_key` with no encryption key.
///
/// Returns the signed attestation as a pretty-printed JSON C string.
/// Caller must free with `darkbloom_enclave_free_string()`.
/// Returns NULL on failure.
@_cdecl("darkbloom_enclave_create_attestation")
public func darkbloom_enclave_create_attestation(
    _ ptr: UnsafeRawPointer
) -> UnsafeMutablePointer<CChar>? {
    return darkbloom_enclave_create_attestation_with_key(ptr, nil)
}
...
/// Caller must free with `darkbloom_enclave_free_string()`.
/// Returns NULL on failure.
@_cdecl("darkbloom_enclave_create_attestation_with_key")
public func darkbloom_enclave_create_attestation_with_key(
    _ ptr: UnsafeRawPointer,
...
@_cdecl("darkbloom_enclave_create_attestation_full")
public func darkbloom_enclave_create_attestation_full(
    _ ptr: UnsafeRawPointer,
    _ encryptionKeyBase64: UnsafePointer<CChar>?,
...
/// Free a C string returned by any `darkbloom_enclave_*` function.
///
...
@_cdecl("darkbloom_enclave_free_string")
public func darkbloom_enclave_free_string(_ ptr: UnsafeMutablePointer<CChar>?) {
    free(ptr)
}
