...
func (s *Controller) requirePublishingAPIKey(w http.ResponseWriter, r *http.Request) (publishingActor, bool) {
	...
	if provided == "" {
		httpresponse.WriteJSON(w, http.StatusUnauthorized, httpresponse.ErrorBody("authentication_error", "missing publishing API key"))
	...
	if err != nil {
		...
		httpresponse.WriteJSON(w, http.StatusInternalServerError, httpresponse.ErrorBody("internal_error", "failed to verify publishing API key"))
		return publishingActor{}, false
	}
	...
	httpresponse.WriteJSON(w, http.StatusUnauthorized, httpresponse.ErrorBody("authentication_error", "invalid publishing API key"))
	return publishingActor{}, false
}
