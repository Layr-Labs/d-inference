...
func (s *Store) migrateUsageTotals(ctx context.Context) error {
	started := time.Now()
...
func (s *Store) applyUsageTotalsMigration(ctx context.Context) (usageTotalsMigrationResult, error) {
...
func (s *Store) prepareUsageTotalsMigration(ctx context.Context) (usageTotalsMigrationPreparation, error) {
...
func (s *Store) finalizeUsageTotalsMigration(
	ctx context.Context,
