...
enum FreshInstallFakeCLI {
    ...
    static func script(processIdentity: ProcessIdentity) -> String {
        ...
        if [ "$#" -eq 4 ] && [ "$1" = models ] && [ "$2" = list ] && [ "$3" = --json ] && [ "$4" = --all ]; then
