    ...
    public static func providerMessage(for outbound: OutboundMessage) -> ProviderMessage {
        ...
        case .attestationResponse(let payload):
            return .attestationResponse(ProviderMessage.AttestationResponse(
                ...
                processEvidenceSignature: payload.processEvidenceSignature,
                publicKey: payload.publicKey,
                processEvidenceVersion: payload.processEvidenceVersion,
                coordinatorSessionId: payload.coordinatorSessionId,
                challengeGeneration: payload.challengeGeneration,
                challengeExpiresAt: payload.challengeExpiresAt,
                sePublicKey: payload.sePublicKey,
                serialNumber: payload.serialNumber,
                providerVersion: payload.providerVersion,
                providerPlatform: payload.providerPlatform,
                providerBackend: payload.providerBackend,
                metallibHash: payload.metallibHash,
