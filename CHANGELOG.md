...
- Clarify on the owner dashboard that a legacy verification badge does not permit Darkbloom MDM removal; `darkbloom unenroll` still requires current App Attest authorization and explicit removal readiness.
