...
func (s *Store) migrateWithdrawableBalance(ctx context.Context) error {
	started := time.Now()
...
func (s *Store) applyWithdrawableBalanceMigration(ctx context.Context) (withdrawableMigrationOutcome, error) {
