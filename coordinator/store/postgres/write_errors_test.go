...
func TestPostgresRouteWritesAfterPoolCloseAreTransient(t *testing.T) {
	...
	updates := []contracts.InferenceRouteOutcomeUpdate{
		{RequestID: id + "-1", Attempt: 1, Outcome: &contracts.InferenceRouteOutcome{FinalStatus: "success"}},
		{RequestID: id + "-2", Attempt: 1, Outcome: &contracts.InferenceRouteOutcome{FinalStatus: "success"}},
	}
