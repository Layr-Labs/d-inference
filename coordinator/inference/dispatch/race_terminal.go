...
func (d *execution) resolvePrimaryRaceChunk(chunk registry.ProviderChunk, ok bool, backupProvider *registry.Provider, backupPR *registry.PendingRequest, backupHeld []string) dispatchOutcome {
	if !ok {
		select {
...
func (d *execution) resolveBackupRaceChunk(chunk registry.ProviderChunk, ok bool, backupProvider *registry.Provider, backupPR *registry.PendingRequest, backupHeld []string) dispatchOutcome {
	if !ok {
		select {
	...
	d.s.deps.Attempts().Cancel(d.provider, d.pr, attemptpolicy.CancelCauseHedgeLoser)
...
func (d *execution) resolvePrimaryRaceError(errMsg protocol.InferenceErrorMessage, backupProvider *registry.Provider, backupPR *registry.PendingRequest, backupHeld []string) dispatchOutcome {
	s := d.s
...
func (d *execution) resolveBackupRaceError(errMsg protocol.InferenceErrorMessage, backupProvider *registry.Provider, backupPR *registry.PendingRequest, backupHeld []string) dispatchOutcome {
	s := d.s
	provider, pr := d.provider, d.pr
