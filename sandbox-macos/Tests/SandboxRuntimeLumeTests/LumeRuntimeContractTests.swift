    ...
    func testRuntimePinMatchesAuditedLockFile() throws {
        ...
        XCTAssertEqual(
            ...
            [
                ...
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedGuestChannelPatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedGuestChannelPatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration.pinnedGuestIdentityPatchPath,
                    sha256: LumeRuntimeConfiguration.pinnedGuestIdentityPatchSHA256
                ),
                LumePatch(
                ...
                LumePatch(
                    path: LumeRuntimeConfiguration
                        .pinnedIsolatedNetworkPatchPath,
                    sha256: LumeRuntimeConfiguration
                        .pinnedIsolatedNetworkPatchSHA256
                ),
                LumePatch(
                    path: LumeRuntimeConfiguration
                        .pinnedGatewayNetworkPatchPath,
                    sha256: LumeRuntimeConfiguration
                        .pinnedGatewayNetworkPatchSHA256
                ),
            ]
        )
